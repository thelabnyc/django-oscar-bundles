...
# =============================================================================
FROM node:24@sha256:9b88dc9f710b76e12126b75cfef561aff0e6fe72ad636a8542551b98891d0547 AS client
...
# =============================================================================
FROM registry.gitlab.com/thelabnyc/python:3.13.1022@sha256:d2e5f1ec28286ce197e4940616cbf6416cf03c39418ea2a590c61a4471059cb3 AS server
